...
<div class="definition">
  <div style="display:flex; align-items:flex-start;">
    ...
    <div>
      Aún no tenemos una definición para Derecho Financiero, si quieres aportar con una, escríbenos por instagram a  <a href="https://www.instagram.com/ddch.uss">@ddch.uss</a>.
    </div>
  </div>
</div>
...
<ul>
  {% assign lemas_in_rama = site.lemas | where_exp: "l", "l.ramas contains 'financiero'" %}
